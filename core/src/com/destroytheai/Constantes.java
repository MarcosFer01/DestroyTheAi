...
public class Constantes {
    ...
    public static final int TAMAÑO_MAPA = 60;

    //Constantes de personajes
    //Constantes del guerrero
    public static final int VIDA_G = 17;
    public static final int DAÑO_G = 2;

    //Constantes del asesino
    public static final int VIDA_A = 13;
    public static final int DAÑO_A = 3;
    ...
    public static final int VIDA_S = 5;
    public static final int DAÑO_S = 2;

    //Constantes del goblin
    public static final int VIDA_N = 7;
    public static final int DAÑO_N = 3;

    //Constantes del ojo
    public static final int VIDA_O = 15;
    public static final int DAÑO_O = 5;
}
